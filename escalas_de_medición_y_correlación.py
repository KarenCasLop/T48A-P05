...
Original file is located at
    https://colab.research.google.com/drive/1gPfVQIw34t_wzDQmw1Qp5sw_CX0z9I7T
...
resultados = regresion_lineal_model_3()
# Imprimir el resultado
print(f"Pendiente (m): {resultados[0]}")
print(f"Ordenada al origen (b): {resultados[1]}")
print(f"Coeficiente de Pearson (c): {resultados[2]}")
...
resultados = regresion_lineal_model_s()
# Imprimir el resultado
print(f"Pendiente (m): {resultados[0]}")
print(f"Ordenada al origen (b): {resultados[1]}")
print(f"Coeficiente de Pearson (c): {resultados[2]}")
...
resultados = regresion_lineal_model_x()
# Imprimir el resultado
print(f"Pendiente (m): {resultados[0]}")
print(f"Ordenada al origen (b): {resultados[1]}")
print(f"Coeficiente de Pearson (c): {resultados[2]}")
...
resultados = regresion_lineal_model_y()
# Imprimir el resultado
print(f"Pendiente (m): {resultados[0]}")
print(f"Ordenada al origen (b): {resultados[1]}")
print(f"Coeficiente de Pearson (c): {resultados[2]}")